...
const paths = {
  ...
  dist:   {
    ...
    js:    {
      ...
      build:    '../../static/assets/js'
    },
    img:    {
      build:    '../../static/assets/images'
    },
    font:    {
      build:    '../../static/assets/fonts'
    },
  },
  src:    {
    base:   {
...
gulp.task('js', function() {
  return gulp
    ...
    // .pipe(uglify())
    .pipe(gulp.dest(paths.dist.js.build))
...
gulp.task('img', function() {
  return gulp
      ...
      // .pipe(uglify())
      .pipe(gulp.dest(paths.dist.img.build));
});

gulp.task('font', function() {
  return gulp
      .src(paths.src.font.files)
      // .pipe(uglify())
      .pipe(gulp.dest(paths.dist.font.build));
});
...
gulp.task('scss', function () {
  ...
  gulp
    ...
    .pipe(gulp.dest(paths.dist.css.build))
...
gulp.task('copy:libs', function() {
  return gulp
    ...
    .pipe(gulp.dest(paths.dist.libs.build))
...
gulp.task('build', gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs'), 'fileinclude', 'js', 'scss', 'html', 'img', 'font'));

gulp.task('default', gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs', 'fileinclude', 'js', 'scss',  'html', 'img', 'font'), gulp.parallel('browsersync', 'watch')));